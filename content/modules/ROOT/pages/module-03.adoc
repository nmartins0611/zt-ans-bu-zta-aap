...
* You will see the SSH private key.

image::vaultsshkey.png[]
...
* **Ansible Automation Platform retrieved the SSH private key for the RHEL ec2 instances, from Vault Enterprise, to allow Ansible to connect to the instances and install Nginx.**
