...
| vault_addr
| Add your vault host here, example: https://vault-48hl9-1.apps.ocpvdev01.rhdp.net
| No
...
| aap_host
| Add your AAP host here, example: https://control-48hl9-1.apps.ocpvdev01.rhdp.net
| No
