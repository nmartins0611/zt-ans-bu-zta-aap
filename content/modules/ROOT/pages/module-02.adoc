...
| **Inventory**
| Ckeck the **[red]#Prompt on launch#** checkbox
|===
...
Now we're **ALMOST SET** to trigger the infrastructure provisioning and automation from Terraform Enterprise, later in the next lab section.
