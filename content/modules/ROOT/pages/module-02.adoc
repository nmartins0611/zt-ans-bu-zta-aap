...
You have now created an Application Role (AppRole) in Vault Enterprise. Ansible Automation Platform and Terraform Enterprise can use this to authenticate against the Vault secret engine.
