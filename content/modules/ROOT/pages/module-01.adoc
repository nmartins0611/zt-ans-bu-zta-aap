...
| Description
| Terraform Enterprise (and cloud) credential type
|===
...
In the left menu, click on `Workspaces` and then click on `Create a Workspace`.  Select `API-Driven Workflow` as the type of workspace.
